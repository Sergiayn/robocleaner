        ...
        <div class="container">
            <div class="block-benefits-inner">
                <div class="benefits_list"
                     :style="screenWidth > 768 ? { backgroundImage: `url(${imgIphone[$i18n.locale]})`} : null">
                    <div class="item">
...
@media (min-width: 1199px)
  .benefits_list
    ...
    .item
      ...
      &:nth-last-child(4) .item-inner, &:nth-last-child(1) .item-inner
        float: right
